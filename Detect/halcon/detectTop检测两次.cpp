    ...
    HTuple hv_BaoLuoDiameterDown, HTuple hv_GouWidthUp, HTuple hv_GouWidthDown, HTuple *hv_Result)
{
  ...
  HObject  ho_region4, ho_gouTopRegions, ho_region2, ho_region3;
  ...
  funCorrectImage(ho_Image, &ho_imageCorrected0, &ho_imageCorrected1);
  ...
  //包络线直径
  fun4(ho_imageCorrected0, &ho_region4, hv_hwnd, hv_input_Scale_1, hv_BaoLuoDiameterDown, 
      hv_BaoLuoDiameterUp, &hv_ret4);
  //第一次检测，如果不合格，再判断第二张
  if (0 != (hv_ret4!=0))
  {
    //擦出第一次外径检测的显示
    if (HDevWindowStack::IsOpen())
      DispObj(ho_imageCorrected1, HDevWindowStack::GetActive());
    //第二次检测
    fun4(ho_imageCorrected1, &ho_region4, hv_hwnd, hv_input_Scale_1, hv_BaoLuoDiameterDown, 
        hv_BaoLuoDiameterUp, &hv_ret4);
    if (0 != (hv_ret4==0))
    {
  ...
  //钩宽，钩变形
  fun2(ho_imageCorrected0, &ho_gouTopRegions, &ho_region2, hv_hwnd, hv_GouWidthDown, 
  ...
  if (0 != (HTuple(hv_ret2==0).TupleAnd(hv_ret4==0)))
  {
    ...
    fun3(ho_imageCorrected0, ho_gouTopRegions, &ho_region3, hv_hwnd, hv_input_Scale_2, 
