    ...
    HTuple hv_BaoLuoDiameterDown, HTuple hv_GouWidthUp, HTuple hv_GouWidthDown, HTuple *hv_Result)
{
  ...
  HObject  ho_gouTopRegions, ho_region2, ho_region3, ho_region4;
  ...
  funCorrectImage(ho_Image, &ho_imageCorrected, &ho_imageCorrected1);

  if (HDevWindowStack::IsOpen())
    DispObj(ho_imageCorrected, HDevWindowStack::GetActive());
  ...
  //钩宽，钩变形
  fun2(ho_imageCorrected1, &ho_gouTopRegions, &ho_region2, hv_hwnd, hv_GouWidthDown, 
  ...
  if (0 != (hv_ret2==0))
  {
    ...
    fun3(ho_imageCorrected1, ho_gouTopRegions, &ho_region3, hv_hwnd, hv_input_Scale_2, 
...
void action()
{
  ...
  if (0 != 1)
  {
    list_image_files("D:/Images/Top/All", "default", HTuple(), &hv_ImageFiles);
